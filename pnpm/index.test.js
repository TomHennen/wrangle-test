// Unit tests for the pnpm fixture, run by wrangle's build_and_publish_npm.yml
// via `pnpm test` (node --test). A failing test fails the build — proof the
// test step is wired up and executed on the pnpm tooling path. Excluded from
// the published tarball by package.json's `files` allowlist.
